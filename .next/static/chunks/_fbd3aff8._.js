...
"[project]/app/admin/providers/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
// --- HELPER COMPONENTS ---
const VerificationStatus = (param)=>{
    let { status } = param;
    const styles = {
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        className: "flex items-center space-x-2 ".concat(styles[status]),
        children: [
            icons[status],
...
const AvailabilityToggle = (param)=>{
    let { status, onChange } = param;
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
        onClick: onChange,
        className: "px-3 py-1 rounded-full text-xs font-semibold transition-colors ".concat(status === 'Available' ? 'bg-green-100 text-green-800' : 'bg-gray-100 text-gray-800'),
        children: status
    }, void 0, false, {
        fileName: "[project]/app/admin/providers/page.tsx",
        lineNumber: 45,
        ...
        children: [
            [
                ...Array(5)
                    ...
                    className: "h-4 w-4 ".concat(i < Math.round(rating) ? 'text-yellow-400' : 'text-gray-300'),
                    fill: "currentColor",
                    viewBox: "0 0 20 20",
...
function ProvidersPage() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ProvidersPage.useEffect": ()=>{
            const unsubscribe = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["onSnapshot"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["collection"])(__TURBOPACK__imported__module__$5b$project$5d2f$app$2f$firebase$2f$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["firestore"], "providers"), {
                "ProvidersPage.useEffect.unsubscribe": (snapshot)=>{
                    const newProviders = snapshot.docs.map({
                        "ProvidersPage.useEffect.unsubscribe.newProviders": (doc)=>({
                                id: doc.id,
                                ...doc.data()
                            })
                    }["ProvidersPage.useEffect.unsubscribe.newProviders"]);
                    setProviders(newProviders);
                }
            }["ProvidersPage.useEffect.unsubscribe"]);
            return ({
                "ProvidersPage.useEffect": ()=>unsubscribe()
            })["ProvidersPage.useEffect"];
        }
    ...
    const filteredAndSortedProviders = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "ProvidersPage.useMemo[filteredAndSortedProviders]": ()=>{
            let sortedProviders = [
                ...providers
            ];
            if (sortConfig !== null) {
                sortedProviders.sort({
                    "ProvidersPage.useMemo[filteredAndSortedProviders]": (a, b)=>{
            ...
            return sortedProviders.filter({
                "ProvidersPage.useMemo[filteredAndSortedProviders]": (provider)=>provider.businessName.toLowerCase().includes(searchTerm.toLowerCase()) || provider.ownerName.toLowerCase().includes(searchTerm.toLowerCase()) || provider.email.toLowerCase().includes(searchTerm.toLowerCase())
            }["ProvidersPage.useMemo[filteredAndSortedProviders]"]);
        }
    }["ProvidersPage.useMemo[filteredAndSortedProviders]"], [
        providers,
        ...
        switch(key){
            case 'services':
                return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: cellValue.map((service)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
            ...
            case 'verification':
                return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(VerificationStatus, {
                    status: cellValue
                }, void 0, false, {
                    fileName: "[project]/app/admin/providers/page.tsx",
                    lineNumber: 145,
            ...
            case 'availability':
                return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(AvailabilityToggle, {
                    status: cellValue,
                            ...
                            children: [
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("thead", {
                                    ...
                                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("tr", {
                                        children: providerColumns.map((col)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("th", {
                                                scope: "col",
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("tbody", {
                                    ...
                                    children: filteredAndSortedProviders.map((provider)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("tr", {
                                            className: "hover:bg-gray-50 transition-colors",
                                            children: providerColumns.map((col)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("td", {
...
_s(ProvidersPage, "MCXzrkcDCC8sH8h12Jh/jedc0l8=");
_c3 = ProvidersPage;
var _c, _c1, _c2, _c3;
__turbopack_context__.k.register(_c, "VerificationStatus");
__turbopack_context__.k.register(_c1, "AvailabilityToggle");
__turbopack_context__.k.register(_c2, "Rating");
__turbopack_context__.k.register(_c3, "ProvidersPage");
...
//# sourceMappingURL=_fbd3aff8._.js.map